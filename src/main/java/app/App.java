...
public class App implements Logic {
    ...
    public void init(Window window) throws Exception {
      ...
      /*  Item box = new Item(mesh);
        box.setScale(0.25f);
        box.setPosition(0, 0, -1);

        Item box1 = new Item(mesh);
        box1.setScale(0.25f);
        box1.setPosition(0.5f, 0, -1);

        Item box2 = new Item(mesh);
        box2.setScale(0.25f);
        box2.setPosition(1f, 0, -1);
...
*/
        ...
        mesh.setColour(new Vector3f(1f, 0.5f, 1f));
