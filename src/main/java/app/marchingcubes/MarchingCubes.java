        ...
        for (int z = 0; z < volDim[2] - 1; z++) {
            for (int y = 0; y < volDim[1] - 1; y++) {
                for (int x = 0; x < volDim[0] - 1; x++) {
                    ...
                    int bits = MCTables.MC_EDGE_TABLE[cubeindex];
                    ...
                    while (MCTables.MC_TRI_TABLE[cubeindex + i] != -1) {
                        int index1 = MCTables.MC_TRI_TABLE[cubeindex + i];
                        int index2 = MCTables.MC_TRI_TABLE[cubeindex + i + 1];
                        int index3 = MCTables.MC_TRI_TABLE[cubeindex + i + 2];
